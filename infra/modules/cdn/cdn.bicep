@metadata({
  moduleDescription: 'CDN module containing CDN profile and endpint'
})
...
output cdnProfleResourceID string = profile.id
output cndEndpointResourceID string = endpoint.id
